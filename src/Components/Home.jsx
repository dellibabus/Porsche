    ...
    return (
        <div className="w-full min-h-screen bg-white text-gray-900 flex flex-col-reverse md:flex-row items-center px-6 md:px-16 lg:px-24 py-12" id="home">
            ...
            <div className="w-full md:w-1/2 text-center md:text-left space-y-6">
                ...
                <p className="text-gray-800 text-base md:text-lg leading-relaxed">The 911 GT3 RS is a limited-production vehicle, making it highly sought after by collectors and driving enthusiasts. Its price reflects its high-performance pedigree and exceptional craftsmanship.</p>
